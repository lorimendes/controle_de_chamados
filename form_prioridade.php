        ...
        <main>
            <section class="buttons">
                ...
                <button class="buttons__item buttons__item-selected"
                    onclick="window.location.href='form_prioridade.php'">Cadastrar
                    prioridade</button>

            </section>
            <section class="forms">

                <h2 class="forms__title">Novo cadastro de prioridade</h2>

                <form action="cadastros.php" method="POST">
                    <label class="forms__label" for="prioridade">Nível de prioridade:</label>
                    <input type="text" name="prioridade" id="idprioridade">
                    <label class="forms__label" for="tempo">Tempo previsto (em horas):</label>
